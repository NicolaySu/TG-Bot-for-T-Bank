...
# Создание таблицы для хранения доходов, расходов, категорий, целей и бюджета
...
async def generate_report(message: Message):
    try:
        ...
        if period == 'day':
            ...
            await message.reply("Неверный период. Используйте 'day', 'week' или 'month'.")
            return
